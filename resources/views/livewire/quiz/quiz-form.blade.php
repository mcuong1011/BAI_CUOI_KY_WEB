<div>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ $editing ? 'Sửa bài kiểm tra' : 'Tạo bài kiểm tra' }}
        </h2>
    </x-slot>

    <x-slot name="title">
        {{ $editing ? 'Sửa bài kiểm tra' . $quiz->id : 'Tạo bài kiểm tra' }}
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form wire:submit.prevent="save">
                        ...
                        <div class="mt-4">
                            <x-input-label for="limited_time" value="Thời gian - số phút làm bài"/>
                            <x-text-input wire:model="quiz.limited_time" id="limited_time" class="block mt-1 w-full"
                                          type="number"
                                          name="limited_time"/>
                            <x-input-error :messages="$errors->get('quiz.limited_time')" class="mt-2"/>
                        </div>
                        <div class="mt-4">
                        ...
                        <div class="mt-4">
                            <x-input-label for="questions" value="Câu hỏi"/>
                            <x-select-list class="w-fit" id="questions" name="questions"
                                           :options="$this->listsForFields['questions']"
                        ...
                        <div class="mt-4">
                            <div class="flex items-center">
                                <x-input-label for="published" value="Bài kiểm tra thành viên"/>
                        ...
                        <div class="mt-4">
                            <div class="flex items-center">
                                <x-input-label for="public" value="Bài luyện tập"/>
